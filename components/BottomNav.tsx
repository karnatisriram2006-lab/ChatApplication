...
const BottomNav = () => {
    ...
    return (
        <nav className="md:hidden fixed bottom-0 left-0 right-0 h-16 bg-sidebar-surface/80 backdrop-blur-2xl border-t border-border z-[100] flex items-center justify-around px-2 pb-safe-bottom">
            ...
            <button className="flex flex-col items-center justify-center touch-target text-text-muted opacity-60">
                <Image src="/team-fill.svg" alt="Teams" width={20} height={20} className="dark:invert" />
                <span className="text-[10px] font-bold mt-1">Teams</span>
            </button>
